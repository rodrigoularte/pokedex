        ...
        <DetailsContainer>
          ...
          <Coluna1Container>
            ...
            {pokemon &&
              pokemon.stats.map((poder) => {
                return (
                  <p key={poder.stat.name}>
                    {poder.stat.name}: {poder.base_stat}
                  </p>
                );
              })}
          </Coluna1Container>
          ...
          <Coluna2Container>
            ...
            <AtaquesContainer>
              ...
              {pokemon &&
                pokemon.moves.map((ataque, i) => {
                  return (
                    i < 5 && <p key={ataque.move.name}>{ataque.move.name}</p>
                  );
                })}
            </AtaquesContainer>
          </Coluna2Container>
